    ...
    <div>
      <div style={{ lineHeight: "2rem" }}>
        ...
        <div>
          ...
          <br />- Diretamente no server component, faça um fetch para a api de
          perfil <br />- Utilize a api https://api.origamid.online/conta/perfil{" "}
          <br />- Use o token de acesso salvo nos cookies para fazer a
          requisição (header <br />- Authorization: Bearer token) <br />-
          Modifique o menu para mostrar o nome do usuário logado <br />- Se o
          usuário não estiver autorizado, mostre um link para a página de login
          no menu
        </div>
      </div>
    </div>
